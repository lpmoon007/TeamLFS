...
import { listPlayableScenarios, listLeaderRuns } from '@/lib/leader-actions';
...
export default async function PlayPage() {
  ...
  const [scenarios, runs] = await Promise.all([listPlayableScenarios(), listLeaderRuns()]);
  ...
  return (
    <div className="play-wrap">
      ...
      <div className="play-body">
        <PlayLibrary scenarios={scenarios} runs={runs} name={(me.displayName || me.email || '').split(' ')[0]} />
        {me.isMaster ? null : (
